...
afni_proc.py -subj_id $subj										\
	...
	-regress_opts_3dD                                       	\
		-jobs 12                                              	\
		-gltsym 'SYM: 0.5*Fst +0.5*Snd -Trd' -glt_label 1 predictive	\
		-gltsym 'SYM: 0.5*Snd +0.5*Trd -Fst' -glt_label 2 predictable	\
		-gltsym 'SYM: Fst +Snd +Trd' -glt_label 3 All_stim      \
