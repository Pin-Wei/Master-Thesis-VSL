...
set stim_dir2 = $top_dir/derivatives/afni_out/SS_results_runs_MNI_3ord_v5/${subj}_r${run}.results
...
afni_proc.py -subj_id $subj										\
	...
	-regress_extra_ortvec 										\
		...
		$stim_dir2/ideal_jigg_onset.1D							\
		$stim_dir2/ideal_jigg_press.1D							\
	-regress_extra_ortvec_labels CSF_WM	jigg_onset jigg_press 	\
