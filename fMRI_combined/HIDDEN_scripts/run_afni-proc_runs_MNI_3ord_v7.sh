...
set prefix = proc.240317.r$run

set scripts_dir = scripts.runs_MNI_3ord_v7
...
set stim_dir = $prep_dir/$subj/func/Timings_v4 
	# jiggle targets are NOT excluded, and the onset of the first trial is set to 1
